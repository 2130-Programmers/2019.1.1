 ...
 *
 */
public class RSideAuto extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	switch (Robot.drivetrainSubsystem.getDataValueFromPosition(0)) {
	    	case 1: 
	    		...
	    		addSequential(new RSSwitchTurnOne(), 1.6);
	    	...
	    	case 0:
	    		switch (Robot.drivetrainSubsystem.getDataValueFromPosition(1)) {
		    		case 1:
		        		...
		        		addSequential(new RSScaleTurnOne(), 1.1);
		        		...
		        		addSequential(new RSScaleTurnTwo(), 1.75);
		        		...
		        		addSequential(new RSScaleTurnThree(), 1.75);
		    		...
		    		case 0:
		        		...
		        		addSequential(new RSFarScaleTurnOne(), 2);
		        		
		        		addSequential(new SFarScaleMoveTwo(), 4);
		        		
		        		addSequential(new RSFarScaleTurnTwo(), 2.5);
