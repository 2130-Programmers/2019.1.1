...
public class OI {
    ...
    public JoystickButton firingRPMButtonCall;
    public JoystickButton engageIntakeSol;
    ...
    public OI() {
        ...
        engageIntakeSol = new JoystickButton(operatorJoy, 8);
        engageIntakeSol.whileHeld(new OpenIntakeSol());
        firingRPMButtonCall = new JoystickButton(operatorJoy, 5);
        firingRPMButtonCall.whenPressed(new AquireFlywheelRPM());
        fireFuelButton = new JoystickButton(operatorJoy, 6);
        fireFuelButton.whileHeld(new FeederCommand());
        intakeButton = new JoystickButton(operatorJoy, 10);
        intakeButton.whileHeld(new intakeIn());


        // SmartDashboard Buttons
        SmartDashboard.putData("MoveForwardDisF", new MoveForwardDisF());
        SmartDashboard.putData("MoveForwardDisG", new MoveForwardDisG());
        SmartDashboard.putData("MoveForwardDisH", new MoveForwardDisH());
        SmartDashboard.putData("TurnToHeadingF", new TurnToHeadingF());
        SmartDashboard.putData("TurnToHeadingG", new TurnToHeadingG());
        SmartDashboard.putData("AutoRoutine1", new AutoRoutine1());
        SmartDashboard.putData("AutoRoutine2", new AutoRoutine2());
        SmartDashboard.putData("AutoRoutine3", new AutoRoutine3());
        SmartDashboard.putData("AutoRoutine6", new AutoRoutine6());
        SmartDashboard.putData("OpenIntakeSol", new OpenIntakeSol());
    ...
    public boolean aquireFiringRPMButtonCall() {
    	return firingRPMButtonCall.get();
    }
    ...
    public boolean intakesSolButtonCall() {
    	return engageIntakeSol.get();
    }
